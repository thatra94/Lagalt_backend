    ...
    public class Seeder
    {
        ...
        public static ICollection<User> SeedUsers()
        {
            ICollection<User> users = new List<User>()
            {
                ...
                new User{ Id = 5, Name = "Nils", UserId = "another-token", ImageUrl = "https://static.wikia.nocookie.net/motibrostet/images/2/2b/Nils_Svendsen.png/revision/latest?cb=20151231015619",
                    Description = "Jeg liker bannan og laban"
                },
                new User{ Id = 6, Name = "Karl Reverud", UserId = "another-token", ImageUrl = "https://static.wikia.nocookie.net/motibrostet/images/8/87/Karl_Reverud.png/revision/latest/scale-to-width-down/340?cb=20200223142852",
                    Description = "Jeg er sjef i C-konsult og liker å pusle med kreative prosjekter på fritiden"
                },
                new User{ Id = 7, Name = "Henry", UserId = "another-token", ImageUrl = "https://1.bp.blogspot.com/-9qzG44d0m30/XfO_Fu_b8NI/AAAAAAAAmu4/OUNLse_hN2sUkeHzxoRWYWmUvn6OqnWWQCLcBGAsYHQ/s1600/48992181_2368337909903300_2220834138863173632_o.jpg",
                    Description = "Jeg er en pensjonist som er glad i likkør"
                },
                new User{ Id = 8, Name = "John", UserId = "another-token", ImageUrl = "https://www.shankarainfra.com/img/avatar.png",
                    Description = "Har master innen IT"
                },
                new User{ Id = 9, Name = "Bjarte", UserId = "another-token", ImageUrl = "https://www.shankarainfra.com/img/avatar.png",
                    Description = "Jeg er en ux-designer med 5 års erfaring"
                },
                new User{ Id = 10, Name = "Anne", UserId = "another-token", ImageUrl = "https://www.shankarainfra.com/img/avatar.png",
                    Description = "Har IT-utdannelse og erfaring innenfor spillutvikling"
                },
                new User{ Id = 11, Name = "Oda", UserId = "another-token", ImageUrl = "https://www.shankarainfra.com/img/avatar.png",
                    Description = "Har IT-utdannelse og erfaring 5 års erfaring innenfor webutvikling"
                },
                new User{ Id = 12, Name = "Tom", UserId = "another-token", ImageUrl = "https://www.shankarainfra.com/img/avatar.png",
                    Description = "Liker å gå fjelltur. Har to katter"
                },
                new User{ Id = 13, Name = "Madeleine Olaussen", UserId = "another-token", ImageUrl = "https://www.shankarainfra.com/img/avatar.png",
                    Description = "Liker å lese og programmere"
                },
                new User{ Id = 14, Name = "Kaare Nordvik", UserId = "another-token", ImageUrl = "https://www.shankarainfra.com/img/avatar.png",
                    Description = "Har utdannelse innenfor IT og liker å gå fjelltur"
                },
                new User{ Id = 15, Name = "Anna Bjørgum", UserId = "another-token", ImageUrl = "https://www.shankarainfra.com/img/avatar.png",
                    Description = "Er youtuber og liker å gå tur"
                },
                new User{ Id = 16, Name = "Christine Haaland", UserId = "another-token", ImageUrl = "https://www.shankarainfra.com/img/avatar.png",
                    Description = "Har erfaring innenfor spillutvikling"
                },
                new User{ Id = 17, Name = "Daniel Engen", UserId = "another-token", ImageUrl = "https://www.shankarainfra.com/img/avatar.png",
                    Description = "Epic gamer og elsker programmering"
                },
                new User{ Id = 18, Name = "Odin Karlsen", UserId = "another-token", ImageUrl = "https://www.shankarainfra.com/img/avatar.png",
                    Description = "Driver med programmering som hobby. Liker å gå tur"
                },
                new User{ Id = 19, Name = "Merete Olsen", UserId = "another-token", ImageUrl = "https://www.shankarainfra.com/img/avatar.png",
                    Description = "Liker å bade"
                },
                new User{ Id = 20, Name = "Astrid Larsen", UserId = "another-token", ImageUrl = "https://www.shankarainfra.com/img/avatar.png",
                    Description = "Liker å jobbe med blender og animasjon"
                },
                new User{ Id = 21, Name = "Thomas Bjørdal", UserId = "another-token", ImageUrl = "https://www.shankarainfra.com/img/avatar.png",
                    Description = "Er soundcloud-artist og har jobbet mye med ableton"
                },
                new User{ Id = 22, Name = "Jan Johansen", UserId = "another-token", ImageUrl = "https://www.shankarainfra.com/img/avatar.png",
                    Description = "Har gått filmskole i lillehammer og har jobbet må mindre produksjoner"
                },
                new User{ Id = 23, Name = "Susanne Rønne", UserId = "another-token", ImageUrl = "https://www.shankarainfra.com/img/avatar.png",
                    Description = "Har utdannelse innen foto. Liker å gå i skogen"
                },
                new User{ Id = 24, Name = "Dorthe Kristensen", UserId = "another-token", ImageUrl = "https://www.shankarainfra.com/img/avatar.png",
                    Description = "Elsker å jobbe med unity og 3d-spill. Epic gamer på fritiden"
                },
                new User{ Id = 25, Name = "Henrik Jørgensen", UserId = "another-token", ImageUrl = "https://www.shankarainfra.com/img/avatar.png",
                    Description = "l33t gamer og har 2 katter"
                },
                new User{ Id = 26, Name = "Hanne Nilsen", UserId = "another-token", ImageUrl = "https://www.shankarainfra.com/img/avatar.png",
                    Description = "Liker å jobbe med react"
                },
                new User{ Id = 27, Name = "Maja Øvrebø", UserId = "another-token", ImageUrl = "https://www.shankarainfra.com/img/avatar.png",
                    Description = "Liker å jobbe med .NET og databaser"
                },
                new User{ Id = 28, Name = "Hedda", UserId = "another-token", ImageUrl = "https://www.shankarainfra.com/img/avatar.png",
                    Description = "Har 20 års erfaring i filmbransjen"
                },
                new User{ Id = 29, Name = "Martin Fosshaug", UserId = "another-token", ImageUrl = "https://www.shankarainfra.com/img/avatar.png",
                    Description = "Liker å jobbe med spillutvikling"
                },
                new User{ Id = 30, Name = "Geir Torvik", UserId = "another-token", ImageUrl = "https://www.shankarainfra.com/img/avatar.png",
                    Description = "Jobber til daglig med musikkproduksjon. Liker også å programmere"
                },
                new User{ Id = 31, Name = "Eivind Magnussen", UserId = "another-token", ImageUrl = "https://www.shankarainfra.com/img/avatar.png",
